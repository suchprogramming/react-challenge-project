            ...
            <Template>
                <div className="container-fluid">
                    <form>
                        ...
                        <div className="form-group">
                        <label>Qty:</label>
                            <select className="form-control" value={this.state.quantity} onChange={(event) => this.menuQuantityChosen(event)}>
                        ...
                        <button type="button" className="btn btn-success" onClick={(event) => this.submitOrder(event)}>Order It!</button>
                    </form>
                </div>
            </Template>
        );
